...
gingx-sdd test --hdu-id HDU-01 --mobile android  # Corre tests E2E en emulador
```

## Seguridad

Las skills oficiales de Google (`github.com/android/skills`) son seguras por defecto.
Gingx-SDD las valida por hash SHA antes de instalarlas automaticamente.

```bash
# Gingx-SDD instala skills oficiales con verificación
gingx-sdd skill install @android/edge-to-edge   # Verifica firma de Google
gingx-sdd skill install android                 # Nuestra skill wrapper
```
