...
### Integracion con Gingx-SDD

```bash
# Gingx-SDD instala playwright-cli + sus skills automaticamente
gingx-sdd skill install playwright   # instala esta skill + playwright-cli --skills
