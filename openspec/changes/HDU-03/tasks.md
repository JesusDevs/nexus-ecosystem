# Tasks: Gingx-SDD Save Harness Integration

- [x] 1. `gingx-sdd save --hdu-id <ID>` — reads spec + design + tasks and builds memory
...
- [x] 6. `gingx-sdd release <version>` — wrapper for `mnemo release`
