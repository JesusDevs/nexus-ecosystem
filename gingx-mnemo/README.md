...
Standalone vector memory system with semantic search, versioning, and portable knowledge packs. Part of the [Gingx-SDD](https://github.com/JesusDevs/gingx-sdd) ecosystem.
...
```bash
# 1. Install
git clone https://github.com/gingx-sdd/gingx-mnemo.git
cd gingx-mnemo && ./install.sh
...
### Gingx-SDD
The [Gingx-SDD](https://github.com/JesusDevs/gingx-sdd) installer includes Mnemo automatically.
